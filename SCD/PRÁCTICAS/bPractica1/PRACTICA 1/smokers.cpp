...
int main()
{
  ...
  thread estanquero;
  thread fumador1, fumador2, fumador3;
  ...
  fumador1 = thread(funcion_hebra_fumador,0);
  fumador2 = thread(funcion_hebra_fumador,1);
  fumador3 = thread(funcion_hebra_fumador,2);
