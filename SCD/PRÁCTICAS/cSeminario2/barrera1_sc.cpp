...
void MBarreraSC::cita( int num_hebra )
{
   ...
   {  
      cola.notify_all();                           //Despierta a todas las hebras simultáneamente que esperan hasta poder acceder al cerrojo
      /*
      for( int i = 0 ; i < num_hebras-1 ; i++ )    //Es lo mismo ya que aquí despierta aleatoriamente una a una cada hebra de la cola
         cola.notify_one() ;
         */
      cont = 0 ;
   }
