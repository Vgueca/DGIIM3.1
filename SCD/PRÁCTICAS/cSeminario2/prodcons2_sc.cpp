...
const int 
    ...
    n_consumidoras = 10;
const int 
    n_producciones_hebra = num_items/n_productoras,
    n_consumiciones_hebra = num_items/n_consumidoras;
...
unsigned
   ...
   n_producidos[n_productoras]={0},
    n_consumidos[n_consumidoras]={0};
...
{
   int contador = n_producidos[num_hebra] + n_producciones_hebra*num_hebra ;
   this_thread::sleep_for( chrono::milliseconds( aleatorio<20,100>() ));
   /*mtx.lock();
   cout << "producido: " << contador << endl << flush ;
   mtx.unlock();*/
   cont_prod[contador] ++ ;
   n_producidos[num_hebra]++;
   return contador ;
}
//----------------------------------------------------------------------
...
int main()
{
  ...
  thread hebra_consumidora[n_consumidoras];
